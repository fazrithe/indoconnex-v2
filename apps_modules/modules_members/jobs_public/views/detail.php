...
<div class="container mb-4">
    ...
    <div class="col-lg-12 msn-widget p-4 rounded-3">
        ...
        <div class="row mb-3">
            <p class="fs-14 text-break"><?php echo $jobs->data_description ?></p>
        </div>
            ...
            <div class="col">
                <div class="d-flex text-gray align-items-start mb-3">
                    ...
                    <div class="d-flex flex-grow-1 flex-row flex-md-column">
                        ...
                        <span class="text-black ms-2 ms-md-0 fs-14 text-wrap">
                        <?php
                ...
                <div class="d-flex text-gray align-items-start mb-3">
                    <div class="flex-shrink-0 d-flex me-3">
                        <span class="material-icons md-18 text-white">place</span>
                    </div>
                    <div class="d-flex flex-grow-1 flex-row flex-md-column">
            ...
            <div class="col">
                <div class="d-flex text-gray align-items-start mb-3">
                    ...
                    <div class="d-flex flex-grow-1 flex-row flex-md-column">
                        ...
                        <span class="text-black ms-2 ms-md-0 fs-14"><a href="<?php echo site_url('user/login') ?>">Login to view</a></span>
                    </div>
                </div>
