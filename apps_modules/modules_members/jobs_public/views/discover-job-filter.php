                ...
                <form action="<?php echo base_url('public/jobs/discover/filter') ?>" class="row p-2 w-100" method="get" role="form">
                    ...
                    <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" value="<?php echo $jobs_name; ?>" class="form-control border-end-2 border-start-0 border-top-0 border-bottom-0 border border-2 rounded-0" placeholder="Search" aria-label="" aria-describedby="basic-addon1" id="" name="job-name">
                    ...
                    <div class="d-flex flex-md-row flex-column gap-2">
						...
						<div class="dropdown dropdown rounded-2 ps-1" style="border: 1px solid rgba(73, 80, 87, .5); -webkit-background-clip: padding-box; background-clip: padding-box;">
                            ...
                            <div class="card border-1">
                                <div class="card-body text-black">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        post by: <br />
                                        <?php echo mb_strimwidth($value['full_name'], 0, 25, "...") ?> <span class="material-icons mx-2 text-verified align-middle" style="font-size: 14px;">check_circle</span></span>
                                    </div>
                                    <div class="fs-12">
