...
<!-- Page Content  -->
<div class="row">
    <div class="col-10 col-md-7 mx-auto px-0">
		...
		<span class="d-flex fw-bold mb-3">Discover Find Employee</span>
            ...
            <div class="d-flex bg-white mb-3">
                <form action="<?php echo base_url('public/jobs/employee/filter') ?>" class="row p-2 w-100" method="get" role="form">
                ...
                <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" value="<?php echo $data_filter['name'] ?>" class="form-control border-end-2 border-start-0 border-top-0 border-bottom-0 border border-2 rounded-0" placeholder="Search" aria-label="" aria-describedby="basic-addon1" id="" name="job-name">
            ...
            <div class="bg-white container d-flex">
                <div class="col">
                    <div class="justify-content-evenly m-3 d-flex align-text-center">
                        ...
                        <span class="ms-auto text-muted">Found <?php echo $total_rows-1 ?> matches</span>
                    </div>
                                ...
                                <div class="card-body text-black">
									<div class="d-flex align-items-center mb-3">
										...
										<div class="d-flex flex-grow-1 ms-3 flex-column">
                                            <span class="fw-semi fs-16"><?php echo $value['data_name'] ?></span>
											<a href="<?php echo site_url('public/user/profile/about/'.$value['username']); ?>">
											<span class="text-muted fs-14"><?php echo $value['fullname'] ?></span></a>
										</div>
									</div>
                                    <div class="fs-12">
