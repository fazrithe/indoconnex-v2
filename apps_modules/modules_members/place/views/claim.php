    ...
    <div class="row">
        <div class="col-11 col-md-7 mx-auto px-0">
            <div class="pt-4 mr-0 bg-indoconnex" >
                <span class="d-flex fw-bold mb-3">Claim Place</span>
                <form action="<?php echo base_url('place/profile/claim') ?>" class="row mx-0 px-0" method="post" role="form" enctype="multipart/form-data">
