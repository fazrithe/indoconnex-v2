            ...
            <div class="pt-4 mr-0 bg-indoconnex" >
                ...
                <div class="d-flex bg-white align-items-center mb-3">
                    ...
                    <div class="flex-column flex-md-row me-2 d-flex">
                        ...
                        <div class="flex-shrink-0 ps-auto text-right m-2 d-grid">
                            <a href="<?php echo site_url('place/manage/setting/'.$value->id)?>" class="btn btn-light" role="button">Manage Place</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
				<?php else: ?>
					<div class="card-body bg-white border-0">
						<div class="d-flex align-items-center flex-column">
							...
							<div class="mb-3">
								<span class="text-muted ">You do not have any place pages yet</span>
							</div>
							<div class="mb-3">
								<a href="<?php echo site_url('business/create') ?>" class="btn btn-danger">Create Place</a>
							</div>
						</div>
					</div>
				<?php endif;?>
