...
class Place extends Base_users
{
	...
	public function list()
	{
		...
		$data['business_list'] = $this->db->get_where('pbd_business',array('users_id'=>$user_id,'status'=>1,'status_page'=>'place'))->result();
	...
	public function discover()
	{
		...
		$config['base_url'] = site_url('place/discover'); //site url
	...
	public function discover_filter()
	{
		...
		$user_id     = $_SESSION['user_id'];
		$name       = $this->input->get('place-name');
		$location   = $this->input->get('place-location');
		$type       = $this->input->get('place-type');
		$category   = $this->input->get('place-categories');
		$sub_category   = $this->input->get('sub-place-categories');
