<!-- Sidebar  -->
<?php $this->load->view($template['partials_sidebar_business_public']); ?>
    ...
    <div class="col-11 col-md-7 mx-auto px-0">
        <div class="pt-4 mr-0 bg-indoconnex" >
            ...
            <div class="d-flex bg-white mb-3">
                <form action="<?php echo base_url('public/discover/business/filter') ?>" class="row p-2 w-100" method="get" role="form">
                    <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" class="form-control border-end-2 border-start-0 border-top-0 border-bottom-0 border border-2 rounded-0" placeholder="Search" aria-label="" aria-describedby="basic-addon1" id="" name="business-name" value="<?php echo !empty($businessName) ? $businessName : '' ?>">
                     ...
                     <div class="row">
						...
						<div class="col-md-4">
                        <select name="business-categories" id="business-categories" class="form-select border-0 fw-semi fs-12">
                        ...
                        <option value="">Country</option>
                            <?php foreach($countries as $value){
                                $selec = '';
                                if(!empty($businessLocation) == $value->id) {
                                    $selec = 'selected';
                                }
                    ...
                    <div id="" class="row row-cols-3 mb-3">
                        ...
                        <div class="col-12 col-xs-6 col-md-4" >
                            <div class="card border-1 h-100">
                                ...
                                <div class="card-body">
									<span class="fs-16 card-title fw-bold"><a class="link-primary" href="<?php echo site_url('public/business/about/'.urlencode($value['data_username'])) ?>"><?php echo $value['data_name'] ?>
