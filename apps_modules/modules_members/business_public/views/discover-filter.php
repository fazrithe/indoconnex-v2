                ...
                <form action="<?php echo base_url('public/discover/business/filter') ?>" class="row p-2 w-100" method="get" role="form">
                    <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" class="form-control border-end-2 border-start-0 border-top-0 border-bottom-0 border border-2 rounded-0" placeholder="Search" aria-label="" aria-describedby="basic-addon1" id="" name="business-name" value="<?php echo $data_filter['name']; ?>">
