    ...
    <div class="row">
        <div class="col-11 col-md-7 mx-auto px-0 g-3">
            <div class="pt-4 mr-0 bg-indoconnex" >
                <span class="d-flex fw-bold mb-3">Create Business <?php echo validation_errors(); ?></span>
                <form action="<?php echo base_url('business/profile/store') ?>" class="row mx-0 px-0" method="post" role="form" enctype="multipart/form-data">
                    <div class="col-12 col-md-6 mb-3 ">
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
									...
									<input type="hidden" name="status_page" value="business">
                                    <input type="text" name="business-name" class="form-control form-control-sm" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Username</label>
                                    <input type="text" name="username" class="form-control form-control-sm input-text" onKeyPress="return angkadanhuruf(event,'abcdefghijklmnopqrstuwvxyz0123456789',this)" placeholder="username" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" name="business-description" for="">Business Description</label>
                        ...
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
                                    <label class="form-label" name="address" for="">Business Address</label>
                        ...
                        <div class="card border-0 mb-3 text-prussianblue" >
                            <div class="card-header bg-transparent text-primary border-0 pt-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-2 d-flex flex-column">
                                    ...
                                    <span class="fs-12">Info about your business contact.</span>
                                </div>
                            </div>
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
