        ...
        <div class="col-11 col-md-7 mx-auto px-0">
            <div class="pt-4 mr-0 bg-indoconnex" >
                <div class="bg-white p-2 me-auto col-6 col-md-5 mb-3">
                    <select name="businessSelector"  class=" js-businessSelector border-0 bg-white p-2" onchange="manage(this.value)">
                ...
                <span class="d-flex fw-bold mb-3">Business Settings</span>
                <form action="<?php echo base_url('business/profile/update') ?>" class="row mx-0 px-0" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control form-control-sm" name="__logo_files[]" id="" accept="image/*" onchange="loadBusinessLogoFile(event)" />
                                </div>
                                <div class="mb-3">
                                    <div id="previewBusinessLogoText" class="d-none">Preview Business Logo:</div>
                                    <img id="businessLogoOutput" class="img-fluid" />
                                </div>
                                <div class="mb-3">
                                    <div>Current Business Logo:</div>
                                    <img class="img-fluid" src="<?php echo placeholder($business->file_path, $business->file_name_original); ?>" />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Business Cover</label>
                                    <input type="file" class="form-control form-control-sm" name="__cover_files[]" id="" accept="image/*" onchange="loadBusinessCoverFile(event)" />
                                </div>
                                <div class="mb-3">
                                    <div id="previewBusinessCoverText" class="d-none">Preview Business Cover:</div>
                                    <img id="businessCoverOutput" class="img-fluid" />
                                </div>
                                <div class="mb-3">
                                    <div>Current Business Cover:</div>
                                    <img class="img-fluid" src="<?php echo placeholder($business->cover_file_path, $business->cover_file_name_original); ?>" />
                                </div>
                            </div>
                        </div>
                        <!-- <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" class="txt_csrfname" name="<?php //$this->security->get_csrf_token_name(); ?>" value="<?php //$this->security->get_csrf_hash(); ?>"><br>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="business-payment" id="" class="form-select form-select-sm">
                                        <option value="0">Select Payment Method</option>
                                        <option value="web" <?php echo $business->bd_paymentmethod == 'web' ? 'selected' : ''; ?>>Checkout on Website</option>
                                        <option value="wa" <?php echo $business->bd_paymentmethod == 'wa' ? 'selected' : ''; ?>>Contact via Whatsapp</option>
                                        <option value="phone" <?php echo $business->bd_paymentmethod == 'phone' ? 'selected' : ''; ?>>Contact via Phone</option>
                                    </select>
                                </div>
                            </div>
                            <div class="d-grid">
                                <button type="submit" class="btn btn-sm btn-danger mb-3">Update Business Page</button><br>
                                <a href="#" class="btn btn-sm btn-outline-monik" role="button" data-bs-toggle="modal" data-bs-target="#modal_delete_business<?php echo $business->id ?>">Delete Business Page</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    const loadBusinessLogoFile = function(event) {
        $('#previewBusinessLogoText').removeClass('d-none');
        const output = document.getElementById('businessLogoOutput');
    ...
    const loadBusinessCoverFile = function(event) {
        $('#previewBusinessCoverText').removeClass('d-none');
        const output = document.getElementById('businessCoverOutput');
        output.src = URL.createObjectURL(event.target.files[0]);
        output.onload = function() {
            URL.revokeObjectURL(output.src);
        }
