            ...
            <div class="d-flex bg-white mb-3">
                ...
                <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" class="form-control 0 border-bottom-0 border border-2 rounded-0" placeholder="Search" aria-label="" aria-describedby="basic-addon1" id="" name="product-name">
                    ...
                    <div class="row">
						<div class="col-md-4">
                            <select name="product-location" id="product-location" class="form-select form-select-sm border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="product-type" id="product-type" class="form-select form-select-sm border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="product-category" id="product-category" class="form-select form-select-sm border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="product-price" id="product-price" class="form-select form-select-sm border-0 fw-semi fs-12 ">
                                <option value="">Select price type</option>
                                <option value="1">Free / For Donation</option>
                        ...
                        <div class="col-md-4">
                            <select name="product-currency" id="product-currency" class="form-select form-select-sm border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="product-label" id="product-label" class="form-select form-select-sm border-0 fw-semi fs-12">
