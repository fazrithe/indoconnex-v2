    ...
    <div class="row">
        <div class="col-11 col-md-7 mx-auto px-0">
            <div class="pt-4 mr-0 bg-indoconnex" >
                <span class="d-flex fw-bold mb-3">Claim Business</span>
                <form action="<?php echo base_url('business/profile/claim') ?>" class="row mx-0 px-0" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="business-username" readonly class="form-control form-control-sm" value="<?php echo $business->data_username ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Business Name</label>
                                    <input type="text" name="business-name" readonly class="form-control form-control-sm"  value="<?php echo $business->data_name ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" name="business-type" for="">Business Type</label>
                                    <select class="form-select form-select-sm" disabled name="business-types[]">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-multiple w-100 form-control form-control-sm" disabled name="business-categories[]" multiple="multiple">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm" readonly name="business-description" id="" cols="30" rows="5"><?php echo $business->data_description ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Business Logo</label>
                                    <input type="file" class="form-control form-control-sm" readonly name="__logo_files[]" id="" accept="image/*" >
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Business Cover</label>
                                    <input type="file" class="form-control form-control-sm" readonly name="__cover_files[]" id="" accept="image/*" >
                                </div>
                            </div>
                        </div>
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" readonly name="business-address" value="<?php echo $business->bd_address ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="selCountry">Business Country</label>
                                    <select class="form-select form-select-sm business-country" disabled name="business-country" id="selCountry" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm" disabled name="business-state" id="selState">
                                    <option value="<?php echo $state->id ?>"><?php echo $state->name ?></option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="selCity">Business City / Regency</label>
                                    <select class="form-select form-select-sm" disabled name="business-city" id="selCity">
                                    <option value="<?php echo $city->id ?>"><?php echo $city->name ?></option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="zipCode">Postal Code</label>
                                    <input type="text" class="form-control form-control-sm" disabled name="zip-code" value="<?php echo $business->bd_address_zipcode ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Google Maps Embed Link</label>
                                    <input type="text" class="form-control form-control-sm" disabled name="maps" id="inputMaps" placeholder="" value="<?php echo $business->bd_maps ?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mb-3 ">
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" readonly name="business-phone"  value="<?php echo $business->bd_phone ?>" placeholder="+62 21 80989999">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="">Business Email</label>
                                    <input type="text" class="form-control form-control-sm" readonly name="business-email"  value="<?php echo $business->bd_email ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="card border-0 mb-3 text-prussianblue" >
                            ...
                            <div class="card-body fs-12 text-black">
                                    ...
                                    <div class="row align-items-center mb-2">
                                        <div class="col-4">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" disabled  name="day[]" value="<?php echo $val2 ?>" aria-expanded="true" id="flexSwitchCheck<?php echo $val2 ?>" data-bs-toggle="collapse" data-bs-target="#work<?php echo $val2 ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-multiple w-100 form-control form-control-sm" disabled name="business-facility[]" multiple="multiple">
                                    <?php
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="business-team" id="business-team" disabled class="form-select form-select-sm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="business-pyment" id="" disabled class="form-select form-select-sm">
						...
						<div class="card border-0 mb-3 text-prussianblue" >
                            <div class="card-header bg-transparent border-0 pt-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-2 d-flex flex-column">
                                    <span class="text-prussianblue fw-bold fs-16">Legal Document</span>
                                    <span class="fs-12 text-black">Your business legal document.</span>
                                </div>
                            </div>
                            <div class="card-body fs-12 text-black">
                                <div class="mb-3">
                                    <label class="form-label" for="">Email</label>
                                    <input type="text" class="form-control form-control-sm" name="business-email-claim" required value="<?php echo $business->bd_email ?>" required>
                                </div>
								<div class="mb-3">
                                    <label class="form-label" for="">Legal Document</label>
                                    <input type="file" class="form-control form-control-sm" accept="application/pdf" name="__business_files" required value="<?php echo $business->bd_email ?>" required>
									<span>File must be either PDF</span>
								</div>
								<div class="mb-3">
                                    <div class="row">
										<label class="form-label" for="">Your relationship with this business?</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="relationship" id="inlineRadio1" value="staf">
										<label class="form-check-label" for="inlineRadio1">Staf</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="relationship" id="inlineRadio2" value="agency">
										<label class="form-check-label" for="inlineRadio2">Agency</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="relationship" id="inlineRadio3" value="partner">
										<label class="form-check-label" for="inlineRadio3">Partner</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="relationship" id="inlineRadio4" value="owner">
										<label class="form-check-label" for="inlineRadio4">Owner</label>
									</div>
								</div>
                            </div>
							<div class="d-grid">
