        ...
        <div class="pt-4 mr-0 bg-indoconnex" >
            ...
            <div class="d-flex bg-white mb-3">
                <form action="<?php echo base_url('place/discover/filter') ?>" class="row p-2 w-100" method="get" role="form">
                    ...
                    <div class="row">
						<div class="col-md-4">
                            <select name="place-location" id="place-location" class="form-select border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="place-type" id="place-type" class="form-select border-0 fw-semi fs-12">
                        ...
                        <div class="col-md-4">
                            <select name="place-categories" id="place-categories" class="form-select border-0 fw-semi fs-12 place-categories">
