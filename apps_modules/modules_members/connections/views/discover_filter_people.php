    ...
    <div class="row">
        <div class="col-11 col-md-7 mx-auto px-0">
            <div class="d-flex bg-white mb-3">
                <form action="<?php echo base_url('connections/discover/people/filter') ?>" class="row p-2 w-100" method="get" role="form">
                    <div class="d-flex justify-content-evenly">
                        <div class="input-group input-group-sm border-0 d-flex align-items-center py-1 mx-auto">
                            ...
                            <input type="text" class="form-control border border-2 rounded-0" placeholder="Search" aria-describedby="basic-addon1" name="people-name" value="<?php echo !empty($people_name) ? $people_name : '' ?>">
            ...
            <div class="bg-white container-fluid d-flex mb-3">
                <div class="col-12">
                    <div class="justify-content-evenly m-3 d-flex align-text-center">
                        ...
                        <span class="ms-auto text-muted">Found <?php echo $total_people ?> matches</span>
                    </div>
