<!-- Sidebar  -->
<?php $this->load->view($template['partials_sidebar_covid']); ?>
    ...
    <div class="col-11 col-md-7 mx-auto px-0">
        <div class="pt-4 mr-0 bg-indoconnex" >
            <div class="d-flex align-items-center mb-4">
                <div>
                    <h4 class="mt-4 title-dark"><?php echo $country_name ?></h4>
...
echo $tgl2;  ?></p>
          ...
          <div class="col-6 col-xs-4 col-md-4">
            <div class="card border-light mb-3">
              ...
              <div class="card-body text-dark" style="background-color:transparent;">
                <p class="card-text p-4 link-info" id="confirm-covid" style="font-weight:bold;background:#f2f4f8;font-size:24px;text-align:right;"></p>
              </div>
            </div>
          </div>
          <div class="col-6 col-xs-4 col-md-4">
            <div class="card border-light mb-3">
              ...
              <div class="card-body text-dark" style="background-color:transparent;">
                <p class="card-text p-4 link-danger" id="death-covid" style="font-weight:bold;background:#f2f4f8;font-size:24px;text-align:right;"></p>
              </div>
            </div>
          </div>
          <div class="col-6 col-xs-4 col-md-4">
            <div class="card border-light mb-3">
              ...
              <div class="card-body text-dark" style="background-color:transparent;">
                <p class="card-text p-4 link-success" id="recover-covid" style="font-weight:bold;background:#f2f4f8;font-size:24px;text-align:right;"></p>
              </div>
            </div>
          </div>
        <!-- Corona Virus Charts-->
        <div class="col-12 col-xs-12 col-md-12">
          <div>
            <div class="card-header p-4 bg-light"><h4 style="color: #0dbaff;">Total Cases</h4></div>
             <canvas class="p-4" id="myChart-cases-covid" width="1600" height="900" style="background:#fff;"></canvas>
          </div>
          </div>
          <div>
            <div class="card-header p-4 bg-light"><h4 style="color: #bd1313;">Total Death</h4></div>
             <canvas class="p-4" id="myChart-death-covid" width="1600" height="900" style="background:#fff;"></canvas>
          </div>
          </div>
          <div>
            <div class="card-header p-4 bg-light"><h4 style="color: #129c1d;">Total Recovered</h4></div>
             <canvas class="p-4" id="myChart-recovered-covid" width="1600" height="900" style="background:#fff;"></canvas>
          </div>
          </div>
       </div>
...
<div class="modal fade" id="modal_country_covid" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('covid/country') ?>" method="post" role="form" enctype="multipart/form-data">
