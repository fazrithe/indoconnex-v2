...
<div class="container mb-4">
    <div class="p-4 msn-widget rounded-3">
        ...
        <div class="row row-cols-2 row-cols-lg-4 g-4">
                ...
                <div class="card h-100">
                    <div class="bg-light d-flex h-100 flex-wrap" data-album="<?php echo $valalbums->id ?>">
                        ...
                        foreach($albums_photo as $valphoto):
                            if($valphoto->pcs_communities_albums_id == $valalbums->id){
                        ?>
                        <div class="d-flex w-50 p-2 order-<?php echo $valalbums->id?> flex-grow-0 flex-shrink-0 align-items-start justify-content-start rounded-3">
                            <a class="d-flex placeholder-glow ratio ratio-1x1" href="<?php echo base_url()?><?php echo 'community/photo_album/'.$valphoto->pcs_communities_albums_id ?>">
            ...
            <!-- Album template -->
            <div class="col">
                <div class="card h-100 w-100" data-bs-target="#albums_community" data-bs-toggle="modal" role="button">
                    <div class="ratio ratio-1x1 bg-light">
                        <span class="material-icons md-48 d-flex justify-content-center align-items-center text-muted">add</span>
                    </div>
