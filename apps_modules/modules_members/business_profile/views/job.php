        ...
        <div class="card-body">
            <div class="d-flex bg-white align-items-center mb-3">
                ...
                <?php if($checkusers_profile){?>
					...
					<?php }else {
                            echo "<div class='flex-shrink-0 ps-auto text-right m-2 d-grid'><a href='#' class='btn btn-danger px-4' role='button' data-bs-toggle='modal' data-bs-target='#modal_apply".$value->id."'>Apply</a>
							</div>";
                        } ?>
                </div>
            </div>
