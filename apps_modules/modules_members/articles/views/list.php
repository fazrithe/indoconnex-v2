...
<main class="py-4">
    <div class="row">
        <div class="col-11 col-md-7 mx-auto px-0 mt-4">
			...
			<span class="d-flex fw-bold mb-3">My Article</span>
				...
				<?php foreach($post_articles as $value):?>
					<div class="article-post d-flex bg-white align-items-center mb-3">
						...
						<div class="d-flex justify-content-center">
							<a href="<?php echo site_url('articles/detail/'.$value->id) ?>" class="btn btn-danger btn-sm text-white" role="button">View Article</a>
						</div>
						</div>
					</div>
				<?php endforeach; ?>
