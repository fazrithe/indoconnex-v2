            ...
            <div class="d-flex bg-white mb-3">
                <form action="<?php echo base_url('buysells/discover/filter') ?>" class="row p-2 w-100" method="get" role="form">
					...
					<div class="col-md-4">
                        ...
                        <select name="product-category" id="" class="form-select border-0 fw-semi fs-12 subcategory">
                            <option value="0">Category</option>
                        </select>
                        <select name="product-currency" id="" class="form-select border-0 fw-semi fs-12">
					    ...
					    <div class="d-flex">
							...
							<div class="mb-3" id="categoryPart" style="display: none;">
                                <select class="form-select border-0 fw-semi fs-12 partCategory" name="part-category">
                                    <option value="0">Select Accesories & Part</option>
                                </select>
                            </div>
						</div>
                </form>
