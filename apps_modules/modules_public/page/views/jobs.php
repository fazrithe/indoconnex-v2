 ...
 <div class="container py-4">
	  ...
	  <div class="container">
        <div class="d-flex align-items-center mb-4">
            <div>
                <h2 class="mt-4 title-dark">Discover Jobs</h2>
                </div>
            <div class="ms-auto">
                <div class="dropdown">
					<?php  if(!empty($this->session->userdata('is_login') == FALSE)){ ?>
                    	<a href="<?php echo site_url("public/jobs/") ?>" style="color:#EE0202 ;">View all</a>
					<?php }else{ ?>
						<a href="<?php echo site_url("jobs/discover/") ?>" style="color:#EE0202 ;">View all</a>
					<?php } ?>
				</div>
            </div>
        </div>
      <!-- Jobs - 1 -->
        <div class="row mt-1">
			...
			<div class="col-6 col-xs-6 col-md-2 d-flex align-items-stretch">
                <div class="card border-0">
                
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <img src="<?php echo base_url() . $value->file_path . $value->file_name_original ?>" class="img-fluid mx-auto" id="" alt="Job Directory" style="object-fit: cover; width: 100px; height: 100px;">
                        </div>
                        <div class="d-flex flex-grow-1 ms-3 flex-column">
                            <a href="<?php echo site_url('public/jobs/detail/'.$value->id); ?>"><span class="fw-semi" style="font-size: .900rem !important;"><?php echo $value->data_name ?></span></a>
                            <span class="text-muted" style="font-size: .700rem !important;">post by: <br /> <?php echo mb_strimwidth($value->fullname, 0, 20, '...') ?> <span class="material-icons mx-1 text-verified align-middle" style="font-size: 14px;">check_circle</span></span>
                        </div>
                    </div>
                    <div class="d-flex flex-grow-1 ms-3 flex-column">
                        <div style="font-size: .800rem !important;"><span class="material-icons fs-12 text-gray me-2">paid</span><?php echo number_format($value->jb_salary_max,2,",","."); ?>/Hours</div>
                        <div style="font-size: .900rem !important;"><span class="material-icons fs-12 text-gray me-2">work</span>
