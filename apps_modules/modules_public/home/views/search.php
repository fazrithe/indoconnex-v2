                ...
                if(!empty($business['query'])){
                    ...
                    <div class="d-flex bg-white align-items-center mb-3">
                        <div class="flex-shrink-0 placeholder-glow align-self-start">
							<img class="search-thumbs ms-3 rounded-3 border" src="<?php echo placeholder_business($value->file_path, $value->file_name_original) ?>" alt="">
                        </div>
                        ...
                        <?php }?>
                            ...
                            ?>
                            <span class="badge fs-12 fw-normal bg-light text-black rounded-pill align-self-start"><?php echo $business_categories[$key]; ?></span>
                            <?php
                            endforeach;
                            endif;
                            ?>
