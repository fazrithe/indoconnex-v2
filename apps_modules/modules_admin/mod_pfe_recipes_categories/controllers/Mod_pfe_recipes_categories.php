...
class Mod_pfe_recipes_categories extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pfe_recipes_categories';
	protected $module_base                  = 'mod_pfe_recipes_categories';
	protected $module_table                 = 'pfe_recipes_categories';
	...
	protected $module_upload_path           = 'public/uploads/pbd_recipes_categories/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Page Recipe Categories';
