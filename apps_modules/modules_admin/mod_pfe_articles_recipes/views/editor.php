            ...
            <form id="form-action" class="form-horizontal" method="post" action="<?php echo current_url(); ?>" role="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
						...
						?>
                        <div class="col-sm-9">
                            <input type="hidden" id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" value="<?php echo $cuisine_id ?>">
                        </div>
                    </div>

                    <div class="form-group">
						<?php
						$input_label       = 'Category Recipes';
						$input_placeholder = $input_label;
						$input_id          = 'data_categories_recipes';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <select id="<?php echo $input_id; ?>" onchange="data_cat()" name="<?php echo $input_name; ?>[]" multiple="multiple" class="form-control select2">
							</select>
                        </div>
                    </div>
					...
					<div class="form-group">
						<?php
						$input_label       = 'Cuisines';
						$input_placeholder = $input_label;
						$input_id          = 'recipes_cuisines';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <input type="text" name="<?php echo $input_name; ?>" class="form-control" id="<?php echo $input_id; ?>" value="<?php echo $input_value; ?>" autocomplete="off" placeholder="<?php echo $input_placeholder; ?>" data-validation="required"/>
                        </div>
                    </div>
                    <div class="form-group">
						<?php
...
<script>
	function data_cat(){
		let data_cat = $("#data_categories_recipes").val();
		let data = data_cat.length;
		datacat = '';
		for(let i = 0; i < data; i++){
			datacat = data_cat[i];
		}	
            $.ajax({
                url : "<?php echo site_url('mod_pfe_articles/get_recipe/');?>"+datacat,
                method : "GET",
                async : false,
                dataType : 'json',
