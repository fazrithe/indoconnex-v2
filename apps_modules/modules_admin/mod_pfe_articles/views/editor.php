            ...
            <form id="form-action" class="form-horizontal" method="post" action="<?php echo current_url(); ?>" role="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <select id="<?php echo $input_id; ?>" onchange="data_cat()" name="<?php echo $input_name; ?>[]" multiple="multiple" class="form-control select2"></select>
                        </div>
                    </div>
...
<script>
	function data_cat(){
		let data_cat = $("#data_categories").val();
		...
		for(let i = 0; i < data; i++){
            ...
            $.ajax({
                ...
                success: function(data){
					if(data.data_name == 'Recipes'){
						window.location.href = "<?php echo site_url('mod_pfe_articles_recipes/add');?>";
					}
				}
            });
	}
