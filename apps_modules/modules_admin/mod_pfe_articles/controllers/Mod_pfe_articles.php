...
class Mod_pfe_articles extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pfe_articles';
	protected $module_base                  = 'mod_pfe_articles';
	...
	{
		parent::__construct();
		$this->apps_title_module = 'Articles';
