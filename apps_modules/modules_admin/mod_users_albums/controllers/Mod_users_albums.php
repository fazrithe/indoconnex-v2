...
class Mod_users_albums extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_users_albums';
    protected $module_base            = 'mod_users_albums';
    protected $module_table           = 'users_albums';
    ...
    protected $module_related_join = [
         ...
         *  "table"  => "users_albums",
         *  "key_pk" => "id",
         *  "key_fk" => "users_albums_id",
         *  "column" => array(
         *     "users_albums.id as category_id",
         *     "users_albums.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */];
    protected $module_upload_path = 'public/uploads/users_albums/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Users Albums';
