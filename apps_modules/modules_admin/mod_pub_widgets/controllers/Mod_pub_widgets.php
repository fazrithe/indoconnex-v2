...
class Mod_pub_widgets extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_widgets';
	protected $module_base                  = 'mod_pub_widgets';
	protected $module_table                 = 'pub_widgets';
	...
	protected $module_related_join          = [
		 ...
		 *  "table"  => "pub_widgets",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_widgets_id",
		 *  "column" => array(
		 *     "pub_widgets.id as category_id",
		 *     "pub_widgets.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_widgets/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Widgets';
