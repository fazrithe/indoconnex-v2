        ...
        <div class="box box-solid">
            ...
            <form id="form-action" class="form-horizontal" method="post" action="<?php echo current_url(); ?>" role="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
					...
					<label for="" class="col-sm-3 control-label text-left"></label>
					<div class="col-sm-2">
						<input class="form-check-input business-page" type="radio" name="status_page" id="businessPage" value="business" <?php echo ($output_result_status['status_page'] == 'business') ? 'checked' : '' ?>>
						<label class="form-check-label" for="flexRadioDefault1">
							Business
						</label>
					</div>
						<input class="form-check-input" type="radio" name="status_page" id="placePage" value="place" <?php echo ($output_result_status['status_page'] == 'place') ? 'checked' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>[]" multiple="multiple" class="form-control select2" require></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="businessUsername" style="display: block;">
						<?php
                        ...
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <input type="text" name="<?php echo $input_name; ?>" onkeypress="return hanyaAngka(event)" class="form-control input-username" id="inputUsername" value="<?php echo $input_value; ?>" autocomplete="off" placeholder="<?php echo $input_placeholder; ?>"/>
                        </div>
                    </div>

					<div class="form-group" id="placeUrlName" style="display: none;">
						<?php
						$input_label       = 'URL Name';
						$input_placeholder = $input_label;
						$input_id          = 'data_url_name';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_name; ?></label>
                        <div class="col-sm-9">
                            <input type="text" name="<?php echo $input_name; ?>" onkeypress="return hanyaAngka2(event)" class="form-control input-url-name" id="inputUrlName" value="<?php echo $input_value; ?>" autocomplete="off" placeholder="<?php echo $input_placeholder; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <textarea id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" class="form-control inputMaps" placeholder="<?php echo $input_placeholder; ?>" autocomplete="off"><?php echo $input_value; ?></textarea>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="<?php echo $input_name_column_1; ?>" class="form-control">
                                            ...
                                            <div class="col-md-4">
                                                <select name="<?php echo $input_name_column_2; ?>" class="form-control select2">
                                            ...
                                            <div class="col-md-4">
                                                <select name="<?php echo $input_name_column_3; ?>" class="form-control select2">
                                                    <option value="">--Choose--</option>
                    ...
                    <div class="form-group">
						...
						$input_value_set   = [
							...
							['id' => 1, 'text' => 'Active', 'selected' => 'selected'],
						];
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
