...
class Mod_pbd_business_distributor_types extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pbd_business_distributor_types';
	protected $module_base                  = 'mod_pbd_business_distributor_types';
	protected $module_table                 = 'pbd_business_distributor_types';
	...
	protected $module_related_dropdown      = [
		 ...
		 * clear array if not use check chain
		 *
		 * "pbd_business_distributor_types" => array(
		 *   "table"  => "table_name",
		 *   "label"  => "Label",
		 *   "name"   => "input_name",
		 *   "column" => array(
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pbd_business_distributor_types" => array(
		 *  "table"  => "pbd_business_distributor_types",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pbd_business_distributor_types_id",
		 *  "column" => array(
		 *     "pbd_business_distributor_types.id as category_id",
		 *     "pbd_business_distributor_types.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pbd_business_distributor_types/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Distributor Types';
