...
class Mod_pcs_communities_albums extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pcs_communities_albums';
    protected $module_base            = 'mod_pcs_communities_albums';
    protected $module_table           = 'pcs_communities_albums';
    ...
    protected $module_related_join = [
         ...
         *
         * "pcs_communities_albums" => array(
         *  "table"  => "pcs_communities_albums",
         *  "key_pk" => "id",
         *  "key_fk" => "pcs_communities_albums_id",
         *  "column" => array(
         *     "pcs_communities_albums.id as category_id",
         *     "pcs_communities_albums.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */];
    protected $module_upload_path = 'public/uploads/pcs_communities_albums/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Communities Albums';
