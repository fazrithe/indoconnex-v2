...
class Mod_pcj_jobs_experiences extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pcj_jobs_experiences';
    protected $module_base            = 'mod_pcj_jobs_experiences';
    protected $module_table           = 'pcj_jobs_experiences';
    ...
    protected $module_related_join = [
         ...
         *
         * "pcj_jobs_experiences" => array(
         *  "table"  => "pcj_jobs_experiences",
         *  "key_pk" => "id",
         *  "key_fk" => "pcj_jobs_experiences_id",
         *  "column" => array(
         *     "pcj_jobs_experiences.id as category_id",
         *     "pcj_jobs_experiences.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pcj_jobs_experiences/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Jobs Experiences';
