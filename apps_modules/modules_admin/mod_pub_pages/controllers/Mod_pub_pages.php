...
class Mod_pub_pages extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'detail'         => 'detail',
	...
	protected $module_url_default           = 'mod_pub_pages';
	protected $module_base                  = 'mod_pub_pages';
	protected $module_table                 = 'pub_pages';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_fk" => "pub_pages_id",
		 *  "column" => array(
		 *     "pub_pages.id as category_id",
		 *     "pub_pages.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_pages/';
	...
	public function detail($parameter_id = null)
	{
		...
		$this->load_extra_css('https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css');
		$this->load_extra_js('https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js');
		$this->display($this->module_page['detail'], $data, []);
	}
