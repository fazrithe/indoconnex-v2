...
$(document).ready(function () {
    dataTableVar = $("#data_tables").DataTable({
        ...
        columnDefs: [
            ...
            {targets: 3, orderable: true, visible: false, width: '30%'},
            {targets: 4, orderable: true, visible: true, width: '10%'},
            {targets: 5, orderable: true, visible: true, width: '10%'},
            {targets: 6, orderable: true, visible: true, width: '5%'},
            {targets: 7, orderable: false, visible: true, width: '1%'},
        ],
    });
