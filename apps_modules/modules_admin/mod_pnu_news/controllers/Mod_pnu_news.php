...
class Mod_pnu_news extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pnu_news';
	protected $module_base                  = 'mod_pnu_news';
	protected $module_table                 = 'pnu_news';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_fk" => "pnu_news_id",
		 *  "column" => array(
		 *     "pnu_news.id as category_id",
		 *     "pnu_news.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */];
	protected $module_upload_path           = 'public/uploads/pnu_news/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'News';
