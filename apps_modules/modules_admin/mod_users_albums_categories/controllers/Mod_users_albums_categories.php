...
class Mod_users_albums_categories extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_users_albums_categories';
    protected $module_base            = 'mod_users_albums_categories';
    protected $module_table           = 'users_albums_categories';
    ...
    protected $module_related_join = [
         ...
         *
         * "users_albums_categories" => array(
         *  "table"  => "users_albums_categories",
         *  "key_pk" => "id",
         *  "key_fk" => "users_albums_categories_id",
         *  "column" => array(
         *     "users_albums_categories.id as category_id",
         *     "users_albums_categories.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/users_albums_categories/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Users Albums Categories';
