...
class Mod_pcj_jobs_industries extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pcj_jobs_industries';
	protected $module_base                  = 'mod_pcj_jobs_industries';
	protected $module_table                 = 'pcj_jobs_industries';
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pcj_jobs_industries" => array(
		 *  "table"  => "pcj_jobs_industries",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pcj_jobs_industries_id",
		 *  "column" => array(
		 *     "pcj_jobs_industries.id as category_id",
		 *     "pcj_jobs_industries.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pcj_jobs_industries/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Jobs Industries';
