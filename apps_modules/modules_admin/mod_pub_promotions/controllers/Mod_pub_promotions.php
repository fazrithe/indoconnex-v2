...
class Mod_pub_promotions extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_promotions';
	protected $module_base                  = 'mod_pub_promotions';
	protected $module_table                 = 'pub_promotions';
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pub_promotions" => array(
		 *  "table"  => "pub_promotions",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_promotions_id",
		 *  "column" => array(
		 *     "pub_promotions.id as category_id",
		 *     "pub_promotions.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_promotions/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Promotions';
