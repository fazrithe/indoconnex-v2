...
class Mod_pcj_jobs_types extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pcj_jobs_types';
    protected $module_base            = 'mod_pcj_jobs_types';
    protected $module_table           = 'pcj_jobs_types';
    ...
    protected $module_related_join = [
         ...
         *
         * "pcj_jobs_types" => array(
         *  "table"  => "pcj_jobs_types",
         *  "key_pk" => "id",
         *  "key_fk" => "pcj_jobs_types_id",
         *  "column" => array(
         *     "pcj_jobs_types.id as category_id",
         *     "pcj_jobs_types.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pcj_jobs_types/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Jobs Types';
