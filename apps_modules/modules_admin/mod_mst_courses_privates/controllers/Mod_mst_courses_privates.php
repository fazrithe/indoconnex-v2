...
class Mod_mst_courses_privates extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_mst_courses_privates';
    protected $module_base            = 'mod_mst_courses_privates';
    protected $module_table           = 'mst_courses_privates';
    ...
    protected $module_related_join = [
         ...
         *
         * "mst_courses_privates" => array(
         *  "table"  => "mst_courses_privates",
         *  "key_pk" => "id",
         *  "key_fk" => "mst_courses_privates_id",
         *  "column" => array(
         *     "mst_courses_privates.id as category_id",
         *     "mst_courses_privates.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/mst_courses_privates/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Master Courses Privates';
