...
class Mod_pub_partners extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_partners';
	protected $module_base                  = 'mod_pub_partners';
	protected $module_table                 = 'pub_partners';
	...
	protected $module_related_join          = [
		 ...
		 *  "table"  => "pub_partners",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_partners_id",
		 *  "column" => array(
		 *     "pub_partners.id as category_id",
		 *     "pub_partners.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_partners/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Partners - Corporate Member & Sponsors';
