...
class Mod_csg_meta extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_csg_meta';
	protected $module_base                  = 'mod_csg_meta';
	protected $module_table                 = 'csg_meta';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_fk" => "csg_meta_id",
		 *  "column" => array(
		 *     "csg_meta.id as category_id",
		 *     "csg_meta.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/csg_meta/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Meta SEO Global';
	...
	private function get_menu_by_parent($parent = 0, $prefix = '', $counted_mode = false)
	{
		...
		$sql           = "SELECT
	                        ...
	                        {$title}, data_keywords, data_description, 
