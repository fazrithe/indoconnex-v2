...
class Mod_pnu_news_categories extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pnu_news_categories';
	protected $module_base                  = 'mod_pnu_news_categories';
	protected $module_table                 = 'pnu_news_categories';
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pnu_news_categories" => array(
		 *  "table"  => "pnu_news_categories",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pnu_news_categories_id",
		 *  "column" => array(
		 *     "pnu_news_categories.id as category_id",
		 *     "pnu_news_categories.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pnu_news_categories/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'News Categories';
