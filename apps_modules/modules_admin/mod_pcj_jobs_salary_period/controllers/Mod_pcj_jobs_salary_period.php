...
class Mod_pcj_jobs_salary_period extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pcj_jobs_salary_period';
    protected $module_base            = 'mod_pcj_jobs_salary_period';
    protected $module_table           = 'pcj_jobs_salary_period';
    ...
    protected $module_related_join = [
         ...
         *
         * "pcj_jobs_salary_period" => array(
         *  "table"  => "pcj_jobs_salary_period",
         *  "key_pk" => "id",
         *  "key_fk" => "pcj_jobs_salary_period_id",
         *  "column" => array(
         *     "pcj_jobs_salary_period.id as category_id",
         *     "pcj_jobs_salary_period.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pcj_jobs_salary_period/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Jobs Salary Period';
