...
class Mod_csg_config extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_csg_config';
	protected $module_base                  = 'mod_csg_config';
	protected $module_table                 = 'csg_config';
	...
	protected $module_related_join          = [
		 ...
		 *  "table"  => "csg_config",
		 *  "key_pk" => "id",
		 *  "key_fk" => "csg_config_id",
		 *  "column" => array(
		 *     "csg_config.id as category_id",
		 *     "csg_config.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/csg_config/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Website Configuration';
	...
	private function get_menu_by_parent($parent = 0, $prefix = '', $counted_mode = false)
	{
		...
		$sql           = "SELECT
	                        ...
	                        {$title}, data_value, data_description, 
