            ...
            <form id="form-action" class="form-horizontal" method="post" action="<?php echo current_url(); ?>" role="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
						<?php
						$input_label       = 'Configuration Name';
                        ...
                        <div class="col-sm-9">
                            ...
                            <p class="text-red" style="margin: 0; padding: 0;">
                                *use for programmer use for selected variable name to page, eg : config_name, config_email, config_footer
                                <br/>
                                <strong>*Please without space, symbols, special characters</strong>
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
						<?php
						$input_label       = 'Configuration Value';
						$input_placeholder = $input_label;
						$input_id          = 'data_value';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
                    ...
                    <div class="form-group">
						<?php
						$input_label       = 'Configuration Description';
						$input_placeholder = $input_label;
                        ...
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <textarea id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" class="form-control" placeholder="<?php echo $input_placeholder; ?>" autocomplete="off" rows="4"><?php echo $input_value; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
						<?php
						$input_label       = 'Configuration Image';
						$input_placeholder = $input_label;
						$input_id          = 'files';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
