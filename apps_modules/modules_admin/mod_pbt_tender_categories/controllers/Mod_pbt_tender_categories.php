...
class Mod_pbt_tender_categories extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pbt_tender_categories';
    protected $module_base            = 'mod_pbt_tender_categories';
    protected $module_table           = 'pbt_tender_categories';
    ...
    protected $module_related_join = [
         ...
         *
         * "pbt_tender_categories" => array(
         *  "table"  => "pbt_tender_categories",
         *  "key_pk" => "id",
         *  "key_fk" => "pbt_tender_categories_id",
         *  "column" => array(
         *     "pbt_tender_categories.id as category_id",
         *     "pbt_tender_categories.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pbt_tender_categories/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Categories Tender';
