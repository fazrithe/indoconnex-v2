...
class Mod_pbt_tender_types extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pbt_tender_types';
    protected $module_base            = 'mod_pbt_tender_types';
    protected $module_table           = 'pbt_tender_types';
    ...
    protected $module_related_join = [
         ...
         *
         * "pbt_tender_types" => array(
         *  "table"  => "pbt_tender_types",
         *  "key_pk" => "id",
         *  "key_fk" => "pbt_tender_types_id",
         *  "column" => array(
         *     "pbt_tender_types.id as category_id",
         *     "pbt_tender_types.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pbt_tender_types/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Tender Types';
