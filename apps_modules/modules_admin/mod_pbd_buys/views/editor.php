            ...
            <form id="form-action" class="form-horizontal" method="post" action="<?php echo current_url(); ?>" role="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
					...
					<div class="form-group">
						...
						<label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
						<div class="col-sm-9">
							<input type="email" name="<?php echo $input_name; ?>" class="form-control" id="<?php echo $input_id; ?>" value="<?php echo $input_value; ?>" autocomplete="off" placeholder="<?php echo $input_placeholder; ?>"/>
						</div>
					</div>

					<div class="form-group">
						<?php
						$input_label       = 'Contact Phone';
						$input_placeholder = $input_label;
						$input_id          = 'data_phone';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
                    ...
                    <div class="form-group">
						<?php
					$input_label       = 'Price Discount';
					$input_placeholder = $input_label;
					$input_id          = 'price_discount';
					$input_name        = $input_id;
					$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
					?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                    ...
                    <div class="form-group">
						<?php
						$input_label       = 'Price Type';
						$input_placeholder = $input_label;
						$input_id          = 'price_type';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						$input_value_set   = [
							['id' => '1', 'text' => 'Free (For Donation, Unsued Products)'],
							['id' => '2', 'text' => 'Fixed Price (Ex : IDR 100.000)'],
							['id' => '3', 'text' => 'Starting at (Ex : Starting at IDR 100.000)'],
							['id' => '4', 'text' => 'Ask for Price (Ex : via Whatsapp/Email)'],
							['id' => '5', 'text' => 'Variable Price (Ex : 1 - 10 IDR 100.000, 11 - 20 IDR 88.000)'],
						];
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <select id="<?php echo $input_id; ?>" name="<?php echo $input_name; ?>" class="form-control select2" onchange="action_price_type(this.value)">
								<?php echo select_dropdown_generate_option($input_value_set, $output_result, $input_label, $input_name); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div id="section_price_low" class="form-group">
						<?php
						$input_label       = 'Price Low';
						$input_placeholder = $input_label;
						$input_id          = 'price_low';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
                    ...
                    <div id="section_price_high" class="form-group">
						<?php
						$input_label       = 'Price High';
						$input_placeholder = $input_label;
						$input_id          = 'price_high';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
                    ...
                    <div id="section_price_variant" class="form-group">
						<?php
						$input_label       = 'Variant Price';
						$input_placeholder = $input_label;
						$input_id          = 'price_variant';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						$input_value_json  = '';
						if (!empty($input_value)) {
							$input_value_json = (array) json_decode($input_value);
						}
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <table class="table table-striped table-condensed">
								<?php for ($i = 0; $i < 10; $i++) { ?>
									<?php
									$input_value_1 = (!empty($input_value_json[$i]->qty)) ? $input_value_json[$i]->qty : '';
									$input_value_2 = (!empty($input_value_json[$i]->price)) ? $input_value_json[$i]->price : '';
									?>
                                    <tr>
                                        <td>
                                            <input type="text" name="price_variant[<?php echo $i; ?>][qty]" value="<?php echo $input_value_1; ?>" class="form-control" placeholder="Qty"/>
                                        </td>
                                        <td>
                                            <input type="text" name="price_variant[<?php echo $i; ?>][price]" value="<?php echo $input_value_2; ?>" class="form-control currency" placeholder="Price"/>
                                        </td>
                                    </tr>
								<?php } ?>
                            </table>
                    ...
                    <div class="form-group">
						...
						$input_label       = '';
						$input_placeholder = $input_label;
						$input_id          = 'status_buy_sells';
						$input_name        = $input_id;
						$input_value       = (!empty($output_result[$input_name])) ? $output_result[$input_name] : '';
						?>
                        <label for="<?php echo $input_id; ?>" class="col-sm-3 control-label text-left"><?php echo $input_label; ?></label>
                        <div class="col-sm-9">
                            <input type="hidden" name="<?php echo $input_name; ?>" class="form-control" id="<?php echo $input_id; ?>" value="1" autocomplete="off" placeholder="<?php echo $input_placeholder; ?>"/>
                        </div>
                    </div>
