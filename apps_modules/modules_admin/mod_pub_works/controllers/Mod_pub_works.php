...
class Mod_pub_works extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_works';
	protected $module_base                  = 'mod_pub_works';
	protected $module_table                 = 'pub_works';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_fk" => "pub_works_id",
		 *  "column" => array(
		 *     "pub_works.id as category_id",
		 *     "pub_works.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_works/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'How does Indoconnex Work';
