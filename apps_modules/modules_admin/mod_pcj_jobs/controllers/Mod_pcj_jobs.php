...
class Mod_pcj_jobs extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pcj_jobs';
	protected $module_base                  = 'mod_pcj_jobs';
	protected $module_table                 = 'pcj_jobs';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_fk" => "pcj_jobs_id",
		 *  "column" => array(
		 *     "pcj_jobs.id as category_id",
		 *     "pcj_jobs.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */];
	protected $module_upload_path           = 'public/uploads/pcj_jobs/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Jobs';
