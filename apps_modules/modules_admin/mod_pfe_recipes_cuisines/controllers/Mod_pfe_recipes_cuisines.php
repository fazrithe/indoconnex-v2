...
class Mod_pfe_recipes_cuisines extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pfe_recipes_cuisines';
	protected $module_base                  = 'mod_pfe_recipes_cuisines';
	protected $module_table                 = 'pfe_recipes_cuisines';
	...
	protected $module_upload_path           = 'public/uploads/pbd_recipes_cuisines/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Page Recipe Cuisines';
