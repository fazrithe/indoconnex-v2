...
class Mod_mst_works_experiences extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_mst_works_experiences';
    protected $module_base            = 'mod_mst_works_experiences';
    protected $module_table           = 'mst_works_experiences';
    ...
    protected $module_related_join = [
         ...
         *
         * "mst_works_experiences" => array(
         *  "table"  => "mst_works_experiences",
         *  "key_pk" => "id",
         *  "key_fk" => "mst_works_experiences_id",
         *  "column" => array(
         *     "mst_works_experiences.id as category_id",
         *     "mst_works_experiences.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/mst_works_experiences/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Master Works Experiences';
