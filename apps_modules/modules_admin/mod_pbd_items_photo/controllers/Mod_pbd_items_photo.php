...
class Mod_pbd_items_photo extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pbd_items_photo';
    protected $module_base            = 'mod_pbd_items_photo';
    protected $module_table           = 'pbd_items_photo';
    ...
    protected $module_related_join = [
         ...
         *
         * "pbd_items_photo" => array(
         *  "table"  => "pbd_items_photo",
         *  "key_pk" => "id",
         *  "key_fk" => "pbd_items_photo_id",
         *  "column" => array(
         *     "pbd_items_photo.id as category_id",
         *     "pbd_items_photo.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */];
    protected $module_upload_path = 'public/uploads/pbd_items_photo/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Items Photo';
