...
class Mod_pbd_items_labels extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pbd_items_labels';
	protected $module_base                  = 'mod_pbd_items_labels';
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pbd_items_labels" => array(
		 *  "table"  => "pbd_items_labels",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pbd_items_labels_id",
		 *  "column" => array(
		 *     "pbd_items_labels.id as label_id",
		 *     "pbd_items_labels.data_name as label_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	...
	{
		parent::__construct();
		$this->apps_title_module = 'Items labels';
