...
class Mod_pbd_business_types extends Base_admin
{
    ...
    protected $module_url_default           = 'mod_pbd_business_types';
    protected $module_base                  = 'mod_pbd_business_types';
    protected $module_table                 = 'pbd_business_types';
    ...
    protected $module_related_join          = array(
         ...
         *
         * "pbd_business_types" => array(
         *  "table"  => "pbd_business_types",
         *  "key_pk" => "id",
         *  "key_fk" => "pbd_business_types_id",
         *  "column" => array(
         *     "pbd_business_types.id as category_id",
         *     "pbd_business_types.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    );
    protected $module_upload_path           = 'public/uploads/pbd_business_types/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Business Types';
