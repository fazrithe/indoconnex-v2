...
class Mod_pcs_communities_categories extends Base_admin
{
    ...
    protected $module_url_default           = 'mod_pcs_communities_categories';
    protected $module_base                  = 'mod_pcs_communities_categories';
    protected $module_table                 = 'pcs_communities_categories';
    ...
    protected $module_related_dropdown      = array(
         ...
         * clear array if not use check chain
         *
         * "pcs_communities_categories" => array(
         *   "table"  => "table_name",
         *   "label"  => "Label",
         *   "name"   => "input_name",
         *   "column" => array(
    ...
    protected $module_related_join          = array(
         ...
         *
         * "pcs_communities_categories" => array(
         *  "table"  => "pcs_communities_categories",
         *  "key_pk" => "id",
         *  "key_fk" => "pcs_communities_categories_id",
         *  "column" => array(
         *     "pcs_communities_categories.id as category_id",
         *     "pcs_communities_categories.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */);
    protected $module_upload_path           = 'public/uploads/pcs_communities_categories/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Communities Categories';
