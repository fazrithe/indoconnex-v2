...
class Mod_pbd_business_categories extends Base_admin
{
    ...
    protected $module_url_default           = 'mod_pbd_business_categories';
    protected $module_base                  = 'mod_pbd_business_categories';
    protected $module_table                 = 'pbd_business_categories';
    ...
    protected $module_related_join          = array(
         ...
         *
         * "pbd_business_categories" => array(
         *  "table"  => "pbd_business_categories",
         *  "key_pk" => "id",
         *  "key_fk" => "pbd_business_categories_id",
         *  "column" => array(
         *     "pbd_business_categories.id as category_id",
         *     "pbd_business_categories.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    );
    protected $module_upload_path           = 'public/uploads/pbd_business_categories/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Business Categories';
