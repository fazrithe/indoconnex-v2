...
class Mod_pbd_business_files extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pbd_business_files';
    protected $module_base            = 'mod_pbd_business_files';
    protected $module_table           = 'pbd_business_files';
    ...
    protected $module_related_join = [
         ...
         *
         * "pbd_business_files" => array(
         *  "table"  => "pbd_business_files",
         *  "key_pk" => "id",
         *  "key_fk" => "pbd_business_files_id",
         *  "column" => array(
         *     "pbd_business_files.id as category_id",
         *     "pbd_business_files.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */];
    protected $module_upload_path = 'public/uploads/pbd_business_files/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Business Files';
