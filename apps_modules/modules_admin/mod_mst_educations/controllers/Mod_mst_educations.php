...
class Mod_mst_educations extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_mst_educations';
    protected $module_base            = 'mod_mst_educations';
    protected $module_table           = 'mst_educations';
    ...
    protected $module_related_join = [
         ...
         *
         * "mst_educations" => array(
         *  "table"  => "mst_educations",
         *  "key_pk" => "id",
         *  "key_fk" => "mst_educations_id",
         *  "column" => array(
         *     "mst_educations.id as category_id",
         *     "mst_educations.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/mst_educations/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Master Educations';
