...
class Mod_pub_supports extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_supports';
	protected $module_base                  = 'mod_pub_supports';
	protected $module_table                 = 'pub_supports';
	...
	protected $module_related_join          = [
		 ...
		 *  "table"  => "pub_supports",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_supports_id",
		 *  "column" => array(
		 *     "pub_supports.id as category_id",
		 *     "pub_supports.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_supports/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Supported by';
