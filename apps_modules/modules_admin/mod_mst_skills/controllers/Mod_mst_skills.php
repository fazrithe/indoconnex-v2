...
class Mod_mst_skills extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_mst_skills';
    protected $module_base            = 'mod_mst_skills';
    protected $module_table           = 'mst_skills';
    ...
    protected $module_related_join = [
         ...
         *  "table"  => "mst_skills",
         *  "key_pk" => "id",
         *  "key_fk" => "mst_skills_id",
         *  "column" => array(
         *     "mst_skills.id as category_id",
         *     "mst_skills.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/mst_skills/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Master Skills';
