...
class Mod_mst_facilities extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_mst_facilities';
	protected $module_base                  = 'mod_mst_facilities';
	protected $module_table                 = 'mst_facilities';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_pk" => "id",
		 *  "key_fk" => "mst_facilities_id",
		 *  "column" => array(
		 *     "mst_facilities.id as category_id",
		 *     "mst_facilities.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/mst_facilities/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Master Facilites';
