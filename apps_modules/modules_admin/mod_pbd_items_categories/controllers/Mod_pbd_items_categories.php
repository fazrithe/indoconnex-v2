...
class Mod_pbd_items_categories extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pbd_items_categories';
	protected $module_base                  = 'mod_pbd_items_categories';
	protected $module_table                 = 'pbd_items_categories';
