...
class Mod_pub_page_banners extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_page_banners';
	protected $module_base                  = 'mod_pub_page_banners';
	protected $module_table                 = 'pub_page_banners';
	...
	protected $module_related_join          = [
		 ...
		 *
		 * "pub_page_banners" => array(
		 *  "table"  => "pub_page_banners",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_page_banners_id",
		 *  "column" => array(
		 *     "pub_page_banners.id as category_id",
		 *     "pub_page_banners.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_page_banners/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Public Page Banners';
