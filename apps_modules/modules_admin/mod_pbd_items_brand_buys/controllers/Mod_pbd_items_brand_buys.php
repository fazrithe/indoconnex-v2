...
class Mod_pbd_items_brand_buys extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pbd_items_brand_buys';
	protected $module_base                  = 'mod_pbd_items_brand_buys';
	protected $module_table                 = 'pbd_items_sells_brands';
	...
	{
		parent::__construct();
		$this->apps_title_module = 'Items Brands';
