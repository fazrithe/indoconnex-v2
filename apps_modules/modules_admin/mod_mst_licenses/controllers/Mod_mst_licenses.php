...
class Mod_mst_licenses extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_mst_licenses';
    protected $module_base            = 'mod_mst_licenses';
    protected $module_table           = 'mst_licenses';
    ...
    protected $module_related_join = [
         ...
         *  "table"  => "mst_licenses",
         *  "key_pk" => "id",
         *  "key_fk" => "mst_licenses_id",
         *  "column" => array(
         *     "mst_licenses.id as category_id",
         *     "mst_licenses.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/mst_licenses/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Master Licenses';
