...
class Mod_pcs_communities extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pcs_communities';
	protected $module_base                  = 'mod_pcs_communities';
	protected $module_table                 = 'pcs_communities';
	...
	protected $module_related_join          = [
		 ...
		 *  "key_pk" => "id",
		 *  "key_fk" => "pcs_communities_id",
		 *  "column" => array(
		 *     "pcs_communities.id as category_id",
		 *     "pcs_communities.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pcs_communities/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'Communities';
