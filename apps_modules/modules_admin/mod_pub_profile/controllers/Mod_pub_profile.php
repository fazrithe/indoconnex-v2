...
class Mod_pub_profile extends Base_admin
{
	private   $module_page                  = [
		'index'         => 'index',
		'editor'        => 'editor',
	...
	protected $module_url_default           = 'mod_pub_profile';
	protected $module_base                  = 'mod_pub_profile';
	protected $module_table                 = 'pub_profile';
	...
	protected $module_related_join          = [
		 ...
		 *  "table"  => "pub_profile",
		 *  "key_pk" => "id",
		 *  "key_fk" => "pub_profile_id",
		 *  "column" => array(
		 *     "pub_profile.id as category_id",
		 *     "pub_profile.data_name as category_name"
		 *  )
		 * )
		 */
		/* -------------------------------------------------------- */
	];
	protected $module_upload_path           = 'public/uploads/pub_profile/';

	public function __construct()
	{
		parent::__construct();
		$this->apps_title_module = 'About Profile';
