...
class Mod_pbd_items_photo_categories extends Base_admin
{
    private $module_page = [
        'index'         => 'index',
        'editor'        => 'editor',
    ...
    protected $module_url_default     = 'mod_pbd_items_photo_categories';
    protected $module_base            = 'mod_pbd_items_photo_categories';
    protected $module_table           = 'pbd_items_photo_categories';
    ...
    protected $module_related_dropdown = [
         ...
         * clear array if not use check chain
         *
         * "pbd_items_photo_categories" => array(
         *   "table"  => "table_name",
         *   "label"  => "Label",
         *   "name"   => "input_name",
         *   "column" => array(
    ...
    protected $module_related_join = [
         ...
         *
         * "pbd_items_photo_categories" => array(
         *  "table"  => "pbd_items_photo_categories",
         *  "key_pk" => "id",
         *  "key_fk" => "pbd_items_photo_categories_id",
         *  "column" => array(
         *     "pbd_items_photo_categories.id as category_id",
         *     "pbd_items_photo_categories.data_name as category_name"
         *  )
         * )
         */
        /* -------------------------------------------------------- */
    ];
    protected $module_upload_path = 'public/uploads/pbd_items_photo_categories/';

    public function __construct()
    {
        parent::__construct();
        $this->apps_title_module = 'Items Photo Categories';
