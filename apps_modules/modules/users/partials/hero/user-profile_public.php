    ...
    <div class="px-4 rounded-3 bg-white">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                Work at<b class="ms-2">  <?php echo $value['company']; echo ' ';?>
                </b>
                </div>
                <?php }}} ?>
        ...
        <div>
            <ul class="nav nav-fill px-4" id="navbar-user-profile" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php if ($this->uri->segment(4)=="post") {echo "active";}?>"
                    href="<?php echo site_url('user/login') ?>">Post</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($this->uri->segment(4)=="about") {echo "active";}?>"
                    href="<?php echo site_url('about/'.$users_profile->username) ?>">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($this->uri->segment(4)=="connection") {echo "active";}?>"
                    href="<?php echo site_url('user/login') ?>">Connection</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($this->uri->segment(4)=="photo" or $this->uri->segment(3)=="album") {echo "active";}?>"
                    href="<?php echo site_url('user/login') ?>">Photo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($this->uri->segment(4)=="job") {echo "active";}?>"
