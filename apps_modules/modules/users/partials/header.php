			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							...
							<div class="row fw-semi ">
								<div class="col-lg-2 col-6 ms-auto">
									<ul class="list-unstyled">
										...
										<li><a class="nav-link text-black" href="<?php echo base_url().'service/'.preg_replace('/[^a-zA-Z0-9-&]/', '-','Graphic Design') ?>">UI/UX Graphic Design</a></li>
				...
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<!-- <li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle text-prussianblue" href="#" id="navbarDropdown" role="button"
					...
					<li class="nav-item dropdown">
						...
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
							...
							<img src="<?php echo theme_user_locations(); ?>images/icons/become-a-member.png" class="rounded-circle nav-user-img" alt="">
							Become a member
						</a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="<?php echo site_url('user/login') ?>">Login</a></li>
							<li><a class="dropdown-item" href="<?php echo site_url('user/register') ?>">Register</a></li>
						</ul>
						<?php else: ?>
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
							data-bs-toggle="dropdown" aria-expanded="false">
								...
								if(!empty($_SESSION['user_id'])){
									$this->load->view($template['partials_header']);
										...
										if(empty($users->file_name_original)){
											echo "<img src='".base_url()."public/themes/user/images/placehold/user-1x1.png' class='rounded-circle nav-user-img' alt='img' > Hi ".$users->username."";
										}else{
											echo "<img src='".base_url().$users->file_path . $users->file_name_original."' class='rounded-circle nav-user-img' alt='img' > Hi ".$users->username."";
									}
								}
							?>
						</a>
