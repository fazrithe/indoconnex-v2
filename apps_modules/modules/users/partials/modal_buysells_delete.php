<?php
    foreach($post_buysells as $value){
    $buysells_id            = $value->id;
?>
    <div class="modal fade" id="del_buysells<?php echo $buysells_id ?>" tabindex="-1" aria-labelledby="albumslabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <input type="hidden" name="items-id" value="<?php echo $buysells_id ?>" />
            <input type="hidden" name="form" value="profile" />
                <div class="modal-body">
                    <p>Are you sure you want to delete this Buy & Sells Item?</p>
                </div>
                <div class="modal-footer">
                    <input type="hidden" name="tender-id" value="<?php echo $buysells_id;?>">
