    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen">
        <div class="modal-content">
            <div class="modal-body card">
                <div class="row h-100 modal-album">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-3 d-flex flex-column">
                                    <a href="<?php echo site_url('business/post/'.urlencode($business->data_username)) ?>">
                                        <span class="text-prussianblue fw-bold"><?php echo $business->data_name ?></span>
                                    </a>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <li>
                                                <a class="dropdown-item" data-bs-toggle="modal"
                                                    data-bs-target="#photoeditModal" data-photo-id="<?php echo $valphoto->id; ?>">Edit</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" data-bs-toggle="modal"
                                                    data-bs-target="#posttextdeleteModal">Delete</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <?php } ?>
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="d-flex justify-content-center my-2 text-prussianblue">
                                        ...
                                        <div class="d-flex mx-2 align-items-center">
                                            <span class="material-icons md-14 me-2 align-middle">comment</span>
                                            <?php
                                                $this->db->select('*');
                                                $this->db->where('relate_id',$valphoto->id);
                                        ...
                                        <div class="d-flex mx-2 align-items-center">
                                            <span class="material-icons-outlined md-20 me-2 align-middle">share</span>
                            ...
                            <div class='comments w-100' id="<?php "new_comment" ?>">
                                <div id="<?php echo 'comment_field_'.$valphoto->id ?>" class="d-none status-foot row align-items-center">
                                    ...
                                    <button class="btn btn-sm btn-danger fs-12 fw-bold px-3 py-2 " onclick="postCommentAdd('<?php echo $valphoto->id ?>', this)">
...
<div class="modal fade" id="photodeleteModal" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" name="photo-id" id="photo-id">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-muted"
                    data-bs-dismiss="modal">Cancel</button>
